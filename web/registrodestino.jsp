...
<html>
    <%
        Destinos guar = (Destinos) request.getAttribute("destino");/*guardar*/
        Destinos guar1 = (Destinos) request.getAttribute("destino1");/*si ya existe*/
        Destinos eli = (Destinos) request.getAttribute("borrar1");/*eliminar*/
        Destinos eli2 = (Destinos) request.getAttribute("borrar2");/*no eliminar existe*/
        Destinos modi = (Destinos) request.getAttribute("modi");/*modificar*/
    %>
    <%
        ...
        Destinos modificar = (Destinos) request.getAttribute("modificar");
        String tipo = String.valueOf(session.getAttribute("tipo"));
    %>
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>JARS Airline | Destinos</title>
        <!--Favicon-->
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Nuevo registro de país de destino
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.jsp"><i class="fa fa-home"></i> Inicio</a></li>
                        <li><a href="registrodestino.jsp">Registros de país de destino</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form id="form-destino" action="ControladorDestinos" method="post" class="form-horizontal">
                                    <div class="box-body">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Listado de paises de destino</h3>
                                ...
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <form action="ControladorDestinos" method="post">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button value="<%=registro.getIddestino()%>" name="editar" class="btn btn-success"><span class="fa fa-edit"></span></button>

                                                        <%if (ne.buscardestino(registro.getIddestino()) != null) {%>
                                                        <button value="<%=registro.getIddestino()%>" name="borrar" class="btn btn-danger"><span class="fa fa-remove"></span></button> 
                                                            <%} else {%>
                                                        <button value="<%=registro.getIddestino()%>" name="borrar" class="btn btn-danger"><span class="fa fa-trash"></span></button> 
                                                            <%}%>
                                                    </td>
                                                    <td>
                                                        <%if (ne.buscardestino(registro.getIddestino()) != null) {%>
